package com.pab.springcloudeurekaclientprovider4.services;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.pab.springcloudeurekaclientprovider4.interfaces.UserRepository;
...
public class UserService {
    ...
    public Map<String,Object> checkMobile(@RequestParam("mobile") String mobile){
        System.out.println("Web Service要校验的手机号：" + mobile);
    ...
    public Map<String,Object> checkName(@RequestParam("name") String name){
        System.out.println("Web Service要校验的名字是：" + name);
        Map<String,Object>map = new HashMap<>();
    ...
    public void test(){
        ...
        userList1.add(map);
        userList2.add(user);
        String jsonString1 = JSONArray.toJSONString(userList1);
        String jsonString2 = JSONArray.toJSONString(userList2);
        ...
        System.out.println("userToJSON:"+userToJSON); //{"mobile":"13297517768","name":"张三","id":5,"age":28}
        System.out.println("mapToJSON:"+mapToJSON); //{"user":{"mobile":"13297517768","name":"张三","id":5,"age":28}}
        System.out.println("userList1ToJSON:"+userList1ToJSON); //[{"user":{"mobile":"13297517768","name":"张三","id":5,"age":28}}]
        System.out.println("userList2ToJSON:"+userList2ToJSON); //[{"mobile":"13297517768","name":"张三","id":5,"age":28}]

        System.out.println(jsonString1);  //list中装map  [{"user":{"name":"张三","mobile":"13297517768","id":5,"age":28}}]
        System.out.println(jsonString2);  //list中装对象 [{"name":"张三","mobile":"13297517768","id":5,"age":28}]
    }
}
